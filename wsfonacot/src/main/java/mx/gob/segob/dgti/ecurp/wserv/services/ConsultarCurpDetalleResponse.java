...
@XmlRootElement(name = "consultarCurpDetalleResponse")
public class ConsultarCurpDetalleResponse {

    @XmlElementRef(name = "return", namespace = "http://services.wserv.ecurp.dgti.segob.gob.mx", type = JAXBElement.class)
